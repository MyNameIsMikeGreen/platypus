...
Do not make this file writable by the running application. Adding browser-side or API editing changes the security and
persistence model and requires the
